  ...
  <div style="width:80%;margin:0 10%">
    <div style="hight:200px">
      <div class="top-log-style">
        ...
        <el-input v-model="upoplog.hrname"
                  placeholder="请输入操作人"
                  style="width:10%;margin-right:10px"></el-input>
        <el-input v-model="upoplog.operate"
                  placeholder="请输入日志描述"
                  style="width:30%;"
                  maxlength="20"
                  type="text"
        ...
        <el-dialog title="日志修改"
          ...
          <el-form :model="oplog"
            ...
            <el-form-item label="日志描述">
              <el-input v-model="oplog.operate"
    ...
    <div>
      <div style="width:40%;height: 400px"> 
            <el-table :data="logtypets"
              ...
              <el-table-column prop="logtypemsg"
                               label="日志类型"
                               width="200">
              </el-table-column>
              <el-table-column prop="adddate"
...
export default {
  ...
  methods: {
    ...
    currentChange (currentPage) {
      ...
      /*分页事件处理*/
    sizeChanget (currentSize) {
      this.sizet = currentSize;
      this.initlogtype();
    },
    currentChanget (currentPage) {
      this.paget = currentPage;
      this.initlogtype();
    },
    initlog () {
      // this.loading = true;
    ...
    initlogtype () {
      ...
      let url = "/system/logtype/?page=" + this.paget + "&size=" + this.sizet;
      if (this.logtype) {
        url += "&logtypet=" + this.logtypet;
        this.logtypet = '';
      }
      ...
      this.getRequest(url).then(resp => {
        if (resp) {
          console.log(resp)
          this.logtypets = resp.data;
          this.totalt = resp.total;
          this.loading = false;
        }
      })
    },
